...
- Runtime-facing work should stay narrow:
  1. preserve current agent UI configuration support
  2. add new public methods only when the audit operator layer genuinely needs them
  3. avoid implementing readiness heuristics here prematurely
